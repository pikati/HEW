...
#define MAX_STORM_PARTICLE 120

class SandStormParticle : public Emitter
{
private:
	/**
	 *	@brief		頂点バッファを作るよ
	...
	*/
	...
	float	m_radius[MAX_STORM_PARTICLE];
	float	m_feverAngle[MAX_STORM_PARTICLE];
	float	m_decrease[MAX_STORM_PARTICLE];
public:
	/**
	 *	@brief		デストラクタ
	*/
