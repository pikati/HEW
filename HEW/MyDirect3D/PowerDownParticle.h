...
#define MAX_POWERDOWN_PARTICLE 120

class PowerDownParticle : public Emitter
{
private:
	/**
	 *	@brief		頂点バッファを作るよ
	...
	*/
	...
	float	m_radius[MAX_POWERDOWN_PARTICLE];
	float	m_feverAngle[MAX_POWERDOWN_PARTICLE];
	float	m_decrease[MAX_POWERDOWN_PARTICLE];
public:
	/**
	 *	@brief		デストラクタ
	*/
