...
#define MAX_POWERUP_PARTICLE 120

class PowerUpParticle : public Emitter
{
private:
	/**
	 *	@brief		頂点バッファを作るよ
	...
	*/
	...
	float	m_radius[MAX_POWERUP_PARTICLE];
	float	m_feverAngle[MAX_POWERUP_PARTICLE];
	float	m_decrease[MAX_POWERUP_PARTICLE];
public:
	/**
	 *	@brief		デストラクタ
	*/
